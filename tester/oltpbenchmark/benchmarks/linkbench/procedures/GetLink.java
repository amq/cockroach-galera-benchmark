...
public class GetLink extends Procedure{
    ...
    public Link[] run(Connection conn, long id1, long link_type, long[] id2s) throws SQLException {
        ...
        // gross hack
        getLinkStmt.setSQL(getLinkStmt.getSQL().replaceFirst("LIST", ids));
        ...
        // Long[] list = Arrays.stream(id2s).boxed().toArray(Long[]::new);
        // stmt.setArray(3, conn.createArrayOf("text", list));         
